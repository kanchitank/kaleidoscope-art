$( document ).ready( function () {
  ...
  $kaleidescope.mousemove( function ( e ) {
    ...
    //\\//\\ - by commenting out both below, we're making the mouse motion NOT affect the self-running anim in any way!
    //\\//\\move( nx, ny ); // DO NOTHING!! - Saty // commenting this out makes the mouse NOT change the anim!
    //\\//\\auto = auto_throttle = false; // commenting out makes mouse motion NOT pause the anim!
  });
